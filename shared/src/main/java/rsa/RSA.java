...
public final class RSA {
    ...
    /**
     * Funkcja służy do szyfrowania przesłanej wiadomości w postaci tablicy bajtów
     ...
     * @throws java.security.NoSuchAlgorithmException ten wyjątek rzucany jest gdy chcemy wykorzystać
     * konkretny algorytm kryptograficzny lecz nie jest on dostępny w danym środowisku
    ...
    /**
     * 
     * @param toDecrypt jest to tablica bajtów która została zaszyfrowana funkcją encrypt
     * @param key jest to klucz prywatny osoby która odebrała wiadomość
     * @return zwraca rozszyfrowaną tablicę bajtów z której możemy np stworzyć Stringa
     * @throws java.security.NoSuchAlgorithmException ten wyjątek rzucany jest gdy chcemy wykorzystać
     * konkretny algorytm kryptograficzny lecz nie jest on dostępny w danym środowisku
     * @throws java.security.InvalidKeyException wyjątek rzucany gdy klucz jest niesprawny
     * (np. gdy ma nieodpowiednia długość itp)
